---
## Business rules, knowledge skill API endpoints, data models, user flows, UI selectors, and error scenarios for EventHub. Use this knowledge when writing tests, reviewing code, creating scenarios, or answering questions about how EventHub works. 
